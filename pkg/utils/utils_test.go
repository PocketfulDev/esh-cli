...
func TestIncrementTag(t *testing.T) {
	tests := []struct {
		...
		{"dev_0.1.0", false, "dev_0.1.0-1"},   // tag without release suffix -> add release suffix -1
		{"dev_0.1.0", true, "dev_0.1.0-0.1"},  // tag without release suffix -> add release suffix -0.1 for hotfix
		{"stg6_1.2.0", false, "stg6_1.2.0-1"}, // tag without release suffix -> add release suffix -1
		{"stg6_1.2.9", false, "stg6_1.2.9-1"}, // tag without release suffix -> add release suffix -1
		{"", false, ""},                       // empty tag
